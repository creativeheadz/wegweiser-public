$(function () {
    ...
    // Typography helpers for charts: map CSS variables to pixel numbers
    function cssVarPxNumber(varName) {
            ...
            radialBar: {
                ...
                dataLabels: {
                    ...
                    name: {
                        ...
                        show: false,
                        color: '#888',
                        fontSize: cssVarPxNumber('--font-size-sm') || 17
                    },
                    value: {
                        offsetY: 10,
                        color: '#111',
                        fontSize: cssVarPxNumber('--font-size-2xl') || 24,
                        show: true,
                    }
                }
            }
