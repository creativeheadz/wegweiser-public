document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch('/tenant/' + window.tenant_uuid + '/device_health_history')
        .then(r => r.json())
        .then(data => {
            ...
            const opts = {
                width: document.querySelector("#device-health-history").offsetWidth,
                height: 250,
            ...
            document.querySelector("#device-health-history").innerHTML = '';
            const uplot = new uPlot(opts, seriesData, document.querySelector("#device-health-history"));

            // Handle responsive resizing
            window.addEventListener("resize", () => {
                const width = document.querySelector("#device-health-history").offsetWidth;
