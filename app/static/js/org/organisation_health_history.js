$(function () {
    ...
    if ($("#organisation-health-history").length) {
        // Add loading state
        const chartContainer = $("#organisation-health-history");
        chartContainer.addClass('loading');

        $.get('/organisation/' + window.orguuid + '/health_history', function (response) {
            try {
                ...
                // uPlot configuration
                const opts = {
                    title: "Organisation Health History",
                    id: "organisation-health-history",
                ...
                const uplot = new uPlot(opts, data, document.querySelector("#organisation-health-history"));
                ...
                console.error("Error rendering organisation health history chart:", error);
                chartContainer.removeClass('loading');
                chartContainer.html(
            ...
            console.error("Failed to load organisation health history data:", textStatus, errorThrown);
            chartContainer.removeClass('loading');
            chartContainer.html(
